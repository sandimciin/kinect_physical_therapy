...
\subsection{Context}
The use of the Microsoft Kinect body tracking sensor will be essential for the tracking of patients and their exercises. The sensor will act as the main interface between the patient and the software.  
